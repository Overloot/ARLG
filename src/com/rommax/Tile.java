...
public class Tile extends BaseTile{
	...
	public void setCorpse(int corpse){this.corpse = corpse;}
	...
	public Tile(int id, String name, String path, boolean isPassable, boolean isTransparent, boolean isOpenable, boolean isPlaceable, boolean destroyable, int maxHP, String loot, String weaknessFor){
		super(id, name, path, isPassable, isTransparent, isOpenable, isPlaceable, destroyable, maxHP, loot, weaknessFor);
