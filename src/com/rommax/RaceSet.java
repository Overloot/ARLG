...
public class RaceSet{
	...
	*/
	...
	static{
		...
		RACESET[RACE_KOBOLD] 	= new BaseRace(RACE_KOBOLD, "Кобольд", "res/monsters/races/kobold.png", "Раньше кобольды жили дикими племенами высоко в горах, но спустя несколько веков", "научились самым простым ремеслам и торговле. В наше время они все так же ведут", "уединенный образ жизни вдали от цивиллизаций и почти не используют магию.", 10, 10, 12, 4, SkillSet.SKILL_RPOISON);
	}
