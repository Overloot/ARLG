...
public class RaceSet{
	...
	public static final int MAX_RACES = 4;
	...
	static{
		...
		RACESET[RACE_ORC] 	= new BaseRace(RACE_ORC, "Орк", "res/monsters/races/orc.png", "Орки живут дикими варварскими племенами, скитаясь по равнинам да промышляя", "охотой на случайных путников, в надежде на поживу. Природа наградила их крепким", "телосложением и большой физической силой, что помогает им выживать.", 12, 8, 12, 8);
	}
