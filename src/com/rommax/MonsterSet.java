...
MONSTERSET[3] = new BaseMonster(2,3,"Светлячок","res/monsters/whisp.png",10,1,10,1,1,1,2,0,0,0,0,0,0,0,0,2,0,0,0,0,10, 6);
MONSTERSET[4] = new BaseMonster(2,4,"Гоблин","res/monsters/goblin.png",35,6,8,6,10,3,7,0,0,0,-20,0,0,0,0,0,0,0,2,20,10, 8);
MONSTERSET[5] = new BaseMonster(4,5,"Паук","res/monsters/spider.png",30,3,13,5,30,1,5,0,0,0,-30,0,0,0,0,0,-10,2,5,40,10, 6);
MONSTERSET[6] = new BaseMonster(4,6,"Змея","res/monsters/snake.png",50,5,15,5,20,2,7,0,0,0,-30,0,0,0,0,0,-10,3,7,50,10, 6);
