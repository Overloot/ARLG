...
public class ClassSet {
    ...
    static{
        ...
        CLASSSET[CLASS_FIGHTER] = new BaseClass(CLASS_FIGHTER, "Боец", "fighter", "Это воин посвятивший себя множеству изнуряющих тренировок и прошедший", "через множество поединков, став лучшим из лучших. Может быстро перемещаться по", "полю боя и наносить точные и сильные удары по противнику.", 2, 0, 2, 0, SkillSet.SKILL_FIGHTER_1, SkillSet.SKILL_FIGHTER_2, SkillSet.SKILL_FIGHTER_3);
        CLASSSET[CLASS_RANGER] = new BaseClass(CLASS_RANGER, "Рейнжер", "ranger", "Одиночка с остро заточенными инстинктами самосохранения и способностью выжить", "даже в самой неблагоприятной обстановке. Хорошо обучены использованию многих", "видов оружия и способен участвовать в бою независимо от близости врага.", 1, 3, 0, 0, SkillSet.SKILL_RANGER_1, SkillSet.SKILL_RANGER_2, SkillSet.SKILL_RANGER_3);
